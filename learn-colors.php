...
<head>
  <meta charset="UTF-8">
  <title>Learn Colors - KiddiLearn</title>
  <meta content="width=device-width, initial-scale=1.0" name="viewport">

  <!-- Favicon and Template CSS -->
...
<div class="container text-center mb-5">
  ...
  <span class="text-secondary" style="font-family: 'Pacifico', cursive;">Colors</span>
  </h1>
</div>
  ...
  <div class="row g-4">
    ...
    ?>
      <div class="col-6 col-md-4 col-lg-3 wow fadeInUp" data-wow-delay="0.1s">
        <div class="card card-color text-center h-100 bg-light p-3"
             onclick="openZoomModal('<?= $color ?>', '<?= $image ?>')">
          <img src="<?= $image ?>" class="card-img-top" alt="<?= $color ?>">
          <div class="card-body">
            <h3 class="color-title text-dark"><?= $color ?></h3>
          </div>
        </div>
      </div>
    <?php endforeach; ?>
...
<div id="zoomOverlay" class="zoom-overlay">
  <div class="zoom-content">
    ...
    <img id="zoomImage" src="" alt="Zoomed Color">
  </div>
</div>
